    ...
    <>
      <section className="bg-background border-b border-primary/20">
        <div className="container mx-auto px-4 py-20 text-center">
            <div className="bg-primary/10 rounded-full px-4 py-1.5 text-sm text-primary inline-block mb-4 animate-in fade-in slide-in-from-bottom-8 duration-700 shadow-lg shadow-primary/20 border border-orange-500">
